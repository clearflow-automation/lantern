...
const walkthroughStages = [
  ['01 / ASK','Start with one recent job.','We begin with one recent job, and hear how it actually moved.'],
  ['02 / WATCH','Follow the real trail.','Then we follow the messages, files, decisions, and every handoff.'],
  ['03 / WRITE DOWN','Put the process on paper.','We put it on paper, then check it with the team.'],
  ['04 / MEASURE','Separate work from waiting.','Next, we separate working time, waiting time, and cost.'],
  ['05 / REDESIGN','Change the step that holds it up.','We fix the delay, and give every handoff a clear owner.'],
  ['06 / PILOT','Try it, then measure again.','The team tests the new process. Then we measure what changed.']
];
